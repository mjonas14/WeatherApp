$(document).ready(function () {
  ...
  // If one of the cities in the search history is clicked
  ...
  function getWeather(coordinates) {
    ...
    fetch(apiURL)
      ...
      .then(function (data) {
        $cityName.text(
          data.city.name + " (" + data.list[0].dt_txt.substring(0, 11) + ")"
        );
        ...
        $(".text11").text(
          `Temp: ${Math.round(data.list[2].main.temp - 273)}\u00B0C`
        );
        ...
        $(".text21").text(
          `Temp: ${Math.round(data.list[10].main.temp - 273)}\u00B0C`
        );
        ...
        $(".text31").text(
          `Temp: ${Math.round(data.list[18].main.temp - 273)}\u00B0C`
        );
        ...
        $(".text41").text(
          `Temp: ${Math.round(data.list[26].main.temp - 273)}\u00B0C`
        );
        ...
        $(".text51").text(
          `Temp: ${Math.round(data.list[34].main.temp - 273)}\u00B0C`
        );
